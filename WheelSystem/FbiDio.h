...
#define FBIDIO_NO_BUFFER_MODE	0x00000001

#define FBIDIO_SYNC1			0
#define FBIDIO_SYNC2			1

#define FBIDIO_SYNC_DISABLE		0
#define FBIDIO_SYNC_ENABLE		1
...
#define FBIDIO_ERROR_USB_TIMEOUT			0xC0001006	// USB communicate Timeout
#define FBIDIO_ERROR_USBIO_FAILED			0xC0001007	// USB communicate failed
...
FBIDIOAPI INT WINAPI DioWatchPointBack( HANDLE hDeviceHandle, HANDLE hBackGroundHandle, PINT pBuffer, DWORD nNumOfBytesToRead,LPOVERLAPPED lpOverlapped );
...
FBIDIOAPI INT WINAPI DioCommonGetPciDeviceInfo(
								HANDLE hDeviceHandle, PDWORD pdwDeviceID, PDWORD pdwVenderID,
...
FBIDIOAPI INT WINAPI DioSetEventRequestMode( HANDLE DeviceHandle, DWORD EventMode );
	
FBIDIOAPI INT WINAPI DioOutputSync(HANDLE DeviceHandle, INT TrgLine, DWORD UpEdge, DWORD DownEdge);
